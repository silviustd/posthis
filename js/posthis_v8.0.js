...
document.write('<div id="contentDiv">');
     ...
     document.write('<div id=5 class="digg_grey" onclick="switch_css(5)"></div>');
     document.write('<div id=6 class="reddit_grey" onclick="switch_css(6)"></div>');
     document.write('<div id=7 class="stumble_grey" onclick="switch_css(7)"></div>');
    <!--	
     document.write('<div id=14 class="technorati_grey" onclick="switch_css(14)"></div>');
    -->
     document.write('<div id=16 class="socl_grey" onclick="switch_css(16)"></div>');
     document.write('<div id=10 class="delicious_grey" onclick="switch_css(10)"></div>');
     document.write('<div id=8 class="tumblr_grey" onclick="switch_css(8)"></div>');
     document.write('<div id=11 class="blogger_grey" onclick="switch_css(11)"></div>');
     document.write('<div id=12 class="wordpress_grey" onclick="switch_css(12)"></div>');
     document.write('<div id=15 class="email_grey" onclick="switch_css(15)"></div>');
     document.write('<div id=13 class="print_grey" onclick="switch_css(13)"></div>');
