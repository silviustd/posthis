...
document.write('<div id="contentDiv">');
     ...
     document.write('<div id="logo_v" style="display:block;"><img src="http://columnasoft.com/posthis/images/posthis32_w.png" onclick="cs_postthis()"/></div>');  
document.write('</div>');
document.write('</div>');
}
...
document.write('<div id="headerDiv_H" style="display: block;">');
     ...
     document.write('<div id="titleText_H"><a href="javascript:toggle3(&#39;one17&#39;,&#39;post&#39;,&#39;ex_c17&#39;);"><img id="ex_c17" src="http://columnasoft.com/posthis/images/plus_sm.png" width="14" height="12" /></a></div>');
...
document.write('<div id="headerDiv_H32" style="display: block;">');
     ...
     document.write('<div id="titleText_H32"><a href="javascript:toggle4(&#39;one32&#39;,&#39;post32&#39;,&#39;ex_c32&#39;);"><img id="ex_c32" src="http://columnasoft.com/posthis/images/plus_sm.png" width="14" height="12" /></a></div>');
     document.write('<div id="post32" style="display:block;width:76; height:42;">');
     document.write('<img id="post_i" src="' + spath + '"  style="vertical-align:middle;;" onclick="cs_postthis()"/></div>');
...
document.write('<scr'+'ipt type="text/javascript" src="http://columnasoft.com/posthis/js/cs_postthis1.1.js" ></scr'+'ipt>');
...
function toggle3(showHideDiv, switchTextDiv, img_exc) {
	var ele = document.getElementById(showHideDiv);
	var text = document.getElementById(switchTextDiv);
	var img_s = document.getElementById(img_exc);
	if(ele.style.display == "none") {
    		ele.style.display = "block";
			text.innerHTML = '' ;
			document.getElementById("post").style.display = "none";
			img_s.src = "http://columnasoft.com/posthis/images/minus14-12.png";
		...
		img_s.src = "http://columnasoft.com/posthis/images/plus_sm.png";
	}
}



function toggle4(showHideDiv, switchTextDiv, img_exc) {
	var ele = document.getElementById(showHideDiv);
	var text = document.getElementById(switchTextDiv);
        var img_s = document.getElementById(img_exc);
	if(ele.style.display == "none") {
    		ele.style.display = "block";
			//text.innerHTML = '' ;
			text.innerHTML = '<div id="expand_tt_h32" >collapse</div>';
