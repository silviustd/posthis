...
$("#3").append('<div id="d_tt3" class="div_tt">share it on linkedin</div>');
$("#4").append('<div id="d_tt4" class="div_tt">share on google</div>');
$("#5").append('<div id="d_tt5" class="div_tt">digg it</div>');
$("#6").append('<div id="d_tt6" class="div_tt">share on reddit</div>');
$("#7").append('<div id="d_tt7" class="div_tt">share on stumble</div>');
$("#8").append('<div id="d_tt8" class="div_tt">share on tumblr</div>');
$("#9").append('<div id="d_tt9" class="div_tt">pin it</div>');
$("#10").append('<div id="d_tt10" class="div_tt">share on delicious</div>');
$("#11").append('<div id="d_tt11" class="div_tt">share on blogger</div>');
$("#12").append('<div id="d_tt12" class="div_tt">publish on wordpress</div>');
...
$("#16").append('<div id="d_tt16" class="div_tt">share on socl</div>');
...
$("#post32").append('<div id="logou_tt" class="div_tt">post this</div>');
$("#text_h32").append('<div id="logod_tt" class="div_tt">post this</div>');
$("#titleText_H32").append('<div id="dec_tt" class="div_tt">expand</div>');

}
else if (pt_ver == 'p17px') {
 $("#text_v17").append('<div id="logod_tt" class="div_tt">post this</div>');
}
else if (pt_ver == 'h17px') {
 $("#post").append('<div id="logou_tt" class="div_tt">post this</div>');
 $("#text_h17").append('<div id="logod_tt" class="div_tt">post this</div>');
 $("#titleText_H").append('<div id="dec_tt" class="div_tt">expand</div>');
}
...
if (pt_ver == 'e32px') {
   ...
   $("#titleText_H32").mouseenter(function(e) {
   ...
   $("#text_h32").mouseenter(function(e) {
   ...
   $("#text_v17").mouseenter(function(e) {
   ...
   $("#titleText_H").mouseenter(function(e) {
   ...
   $("#text_h17").mouseenter(function(e) {
