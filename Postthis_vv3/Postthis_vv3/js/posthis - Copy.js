...
document.write('<div id="contentDiv">');
     ...
     document.write('<div id=5 class="digg_grey_h32" onclick="switch_css(5)"></div>');
     document.write('<div id=6 class="reddit_grey_h32" onclick="switch_css(6)"></div>');
     document.write('<div id=7 class="stumble_grey_h32" onclick="switch_css(7)"></div>');
    <!--	
     document.write('<div id=14 class="technorati_grey_h32" onclick="switch_css(14)"></div>');
    -->
     document.write('<div id=16 class="socl_grey_h32" onclick="switch_css(16)"></div>');
     document.write('<div id=10 class="delicious_grey_h32" onclick="switch_css(10)"></div>');
     document.write('<div id=8 class="tumblr_grey_h32" onclick="switch_css(8)"></div>');
     document.write('<div id=11 class="blogger_grey_h32" onclick="switch_css(11)"></div>');
     document.write('<div id=12 class="wordpress_grey_h32" onclick="switch_css(12)"></div>');
     document.write('<div id=15 class="email_grey_h32" onclick="switch_css(15)"></div>');
     document.write('<div id=13 class="print_grey_h32" onclick="switch_css(13)"></div>');
     document.write('<div id="titleText"><input type="checkbox" id="isa" onclick="select_alld(32)"/>select all</div>');
     document.write('<div id="titleText"><a id="myHeader" href="javascript:toggle2(&#39;myContent&#39;,&#39;myHeader&#39;);" ><img src="images/minus.png" width="32" height="12"  /></a></div>');
     document.write('<div id="titleText" style="display:block;"><img src="images/logo4_32px.png" onclick="cs_postthis()"/></div>');
  document.write('</div>');
document.write('</div>');
}
...
function toggle3(showHideDiv, switchTextDiv) {
	...
	if(ele.style.display == "none") {
		...
		text.innerHTML = '<img style="border: none;" src="images/posthis17t_white2.png"/>';
	}
}
...
function switch_css(i, st){


var cdiv = document.getElementById(i);

var lst = "_" + st.substring(0,3);
