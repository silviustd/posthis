...
{
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/facebook-grey.png";
}
...
if(tw_2){
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/tw.png";
}
else
{
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/tw-grey.png";
}
break;
...
ld_3=!ld_3;
if(ld_3){
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/linkedin.png";
}
else
{
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/linkedin-grey.png";
}
break;
...
gp_4=!gp_4;
if(gp_4){
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/google.png";
}
else
{
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/google-grey.png";
}
break;
...
dg_5=!dg_5;
if(dg_5){
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/digg.png";
}
else
{
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/digg-grey.png";
}
break;
...
rd_6=!rd_6;
if(rd_6){
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/reddit.png";
}
else
{
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/reddit-grey.png";
}
break;
...
su_7=!su_7;
if(su_7){
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/stumble.png";
}
else
{
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/stumble-grey.png";
}
...
tb_8=!tb_8;
if(tb_8){
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/tumblr.png";
}
else
{
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/tumblr-grey.png";
}
break;
...
pi_9=!pi_9;
if(pi_9){
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/pinterest.png";
}
else
{
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/pinterest-grey.png";
}
break;
...
de_10=!de_10;
if(de_10){
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/delicious.png";
}
else
{
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/delicious-grey.png";
}
break;
...
bg_11=!bg_11;
if(bg_11){
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/blogger.png";
}
else
{
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/blogger-grey.png";
}
break;
...
wp_12=!wp_12;
if(wp_12){
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/wordpress.png";
}
else
{
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/wordpress-grey.png";
}
break;
...
pr_13=!pr_13;
if(pr_13){
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/print.png";
}
else
{
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/print-grey.png";
}
break;
...
te_14=!te_14;
if(te_14){
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/technorati.png";
}
else
{
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/technorati-grey.png";
}
break;
...
em_15=!em_15;
if(em_15){
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/email.png";
}
else
{
cimg.src= "http://columnasoft.com/posthis/images/sntw/icons32px/email-grey.png";
}
break;
