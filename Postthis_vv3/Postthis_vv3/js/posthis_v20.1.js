...
document.write('<div id="headerDiv" style="display: block;">');
     ...
     document.write('<div id="logo" style="display:block;"><img id="post_i" src="http://columnasoft.com/posthis/images/posthis32_w.png" onclick="cs_postthis()" /></div>');
document.write('</div>');
...
document.write('<div id="contentDiv">');
     ...
     document.write('<div id="titleText"><input type="checkbox" id="isa" onclick="select_alld2(32)"/>select all</div>');
     document.write('<div id="titleText"><a id="myHeader" href="javascript:toggle2(&#39;myContent&#39;,&#39;myHeader&#39;);" ><img src="http://columnasoft.com/posthis/images/minus.png" width="32" height="12"  /></a></div>');
     document.write('<div id="titleText" style="display:block;"><img src="http://columnasoft.com/posthis/images/posthis32_w.png" onclick="cs_postthis()"/></div>');
  document.write('</div>');
document.write('</div>');
}
...
document.write('<div id="one" style="display: none; position: absolute; width: 140px; height: 110px; background-color: rgb(245, 245, 245); box-shadow: -1px 1px 1px rgba(0, 0, 0, 0.05), 0pt 0pt 1px white inset; border-radius: 5px 5px 5px 5px; border-bottom: 1px solid rgb(204, 204, 204); border-left: 1px solid rgb(204, 204, 204);">');
    ...
    document.write('<div class="bottom"><div id="titleText"><input id="isa" type="checkbox" onclick="select_alld2(17)">select all</div>');
...
document.write('<div id="headerDiv" style="display: block;">');
     ...
     document.write('<div id="titleText"><input type="checkbox" id="isa" onclick="select_alld2(17)"/>select all</div>');
     document.write('<div id="logo"><img id="post_i" src="http://columnasoft.com/posthis/images/posthis32t_w.png" onclick="cs_postthis()" /></div>');
document.write('</div>');
}
...
document.write('<div id="headerDiv_H" style="display: block;">');
     ...
     document.write('<img id="post_i" src="http://columnasoft.com/posthis/images/posthis17t_white2.png" width="76" height="17" align="absmiddle" onclick="cs_postthis()"/>');
     document.write('</div>');
document.write('<div id="one17">');
     ...
     document.write('<div class="bottom_sm"><div id="titleText"><input type="checkbox" id="isa" onclick="select_alld2(17)"/>select all</div>');
...
document.write('<div id="headerDiv_H32" style="display: block;">');
     ...
     document.write('<div id="post32" style="display:block;">');
     document.write('<img id="post_i" src="http://columnasoft.com/posthis/images/posthis17t_white2.png" width="76" height="17" align="absmiddle" onclick="cs_postthis()"/></div>');
document.write('<div id="one32">');
     ...
     document.write('<div class="bottom_sm32"><div id="titleText"><input type="checkbox" id="isa" onclick="select_alld2(17)" />select all</div>');
     document.write('<img id="post_i2" src="http://columnasoft.com/posthis/images/posthis17_w.png" onclick="cs_postthis()" /></div>');
document.write('</div>');   
document.write('</div>');
}
...
/* block for image begin */
 ...
 if (ver_Ma == 'h17px'){
  ...
  case 7:
    spath = "http://columnasoft.com/posthis/images/logo7_32.png";
    break;
