...
document.write('<div id="one17">');
     ...
     document.write('<div id="bottom_sm"><div id="chkb_h17"><input type="checkbox" id="isa" onclick="select_alld2(17)"/></div>');
...
document.write('<scr'+'ipt type="text/javascript" src="js/cs_postthis1.0.js" ></scr'+'ipt>');
